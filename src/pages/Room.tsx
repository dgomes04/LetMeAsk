...
export function Room() {
    ...
    async function HandleSendQuestion(event: FormEvent) {
        ...
        const roomsRef = ref(database, `rooms/${roomId}/questions`);
        const creatingNewQuestion = push(roomsRef);

        await set(creatingNewQuestion, question)
